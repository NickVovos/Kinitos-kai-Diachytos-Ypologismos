  ...
  Widget build(BuildContext context) {
    ...
    final durationProgress = steps.isNotEmpty
        ? (steps
            ...
            steps.fold<int>(0, (sum, s) => sum + s.duration))
        : 0.0;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    LinearProgressIndicator(
                        value: stepProgress, color: Colors.amber),
                    ...
                    LinearProgressIndicator(
                        value: durationProgress, color: Colors.amber),
                    const SizedBox(height: 20),
                    ...
                    if (currentStep.images.isNotEmpty)
                      SizedBox(
                        height: 200,
                        child: PageView(
                          children: currentStep.images.map((img) {
                            return Padding(
                    ...
                    if (currentStep.ingredients.isNotEmpty)
                      Column(
                        children: [
                          ...
                          ...currentStep.ingredients.map((i) =>
                              Text('${i.name} - ${i.quantity.toString()}')),
                        ],
                      ),
